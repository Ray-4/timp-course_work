...
class Post(models.Model):
    ...
    photo = models.ImageField(verbose_name='Фото', upload_to=get_image_path, null=True, blank=False)

    caption = models.TextField(verbose_name='Подпись', max_length=2200, null=True, blank=True)
    date_posted = models.DateTimeField(default=timezone.now)
    author = models.ForeignKey(User, on_delete=models.CASCADE, related_name='posts')
    location = models.CharField(verbose_name='Место', max_length=30, blank=True)
